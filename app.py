...
from pagina_circuitos import mostrar_pagina_circuitos
...
#Función de "streamlit" que permite mostrar texto con formato. 
# En este caso, se utiliza para inyectar CSS personalizado que mejora la apariencia de la aplicación, 
# dándole un estilo más moderno y atractivo.
st.markdown("""
<style>
/* Fondo general */
.stApp {
...
/* Texto dentro del select (lo que ves antes de abrir) */
[data-baseweb="select"] * {
...
#st.columns permite dividir el espacio horizontal en varias columnas. 
# En este caso, se crean dos columnas con proporciones 1:2, 
# lo que significa que la primera columna ocupará un tercio del ancho disponible 
# y la segunda columna ocupará dos tercios. El parámetro gap="large" añade un espacio
# grande entre las columnas para mejorar la legibilidad y estética de la aplicación.
...
with tab1:
    ...
    #Columna derecha (resultados, grafica, procedimiento)
    with col2:
        if calcular:
            try:
